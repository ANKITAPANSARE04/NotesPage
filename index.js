  ...
  <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
    <div class='card shadow-sm task__card'>
      ...
      <div class='card-body'>
        ...
        <h4 class='task__card__title mb-0 mt-2'>${title}</h4>
        
        <div class='tags text-white d-flex flex-wrap'>
          <span class='badge bg-primary m-1'>${type}</span>
        </div>
        <p class='description trim-3-lines text-muted mx-1' data-gram_editor='false'>
          ${description}
        </p>
      </div>
...
${
  url
    ? `<img src=${url} alt='card image here  class='img-fluid place__holder__image mb-3'/><br/>`
    : `<img height='150px' style="object-fit: cover; object-position: center"  src="https://tse3.mm.bing.net/th?id=OIP.LZsJaVHEsECjt_hv1KrtbAHaHa&pid=Api&P=0" alt='card image cap' class='card-image-top md-3 rounded-lg' /><br/>`
}
